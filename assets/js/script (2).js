document.addEventListener("DOMContentLoaded", () => {
  ...
  const desktopCartCountElement = document.querySelector(".desktop-cart-count")
      ...
      btn.addEventListener("click", function () {
        ...
        if (targetSection) {
          ...
          if (targetElement) {
            ...
            const desktopHeaderOffset = desktopHeader ? desktopHeader.offsetHeight : 0
            const totalOffset = headerOffset + desktopHeaderOffset
  ...
  // Add to cart functionality - update to work with both grid and scroll layouts
  addToCartBtns.forEach((btn) => {
    btn.addEventListener("click", function (e) {
      e.preventDefault()

      // Get property details - updated selector to work with both layouts
  ...
  function updateCartUI() {
    // Update cart count on both mobile and desktop
    cartCountElement.textContent = cartCount
    if (desktopCartCountElement) {
      desktopCartCountElement.textContent = cartCount
    }
  ...
  // Initialize horizontal scrolling for touch devices - keep this for mobile view
